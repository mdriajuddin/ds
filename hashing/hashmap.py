...
class HashMap:
    ...
    # Returns the numnber of entries in the map.
    def __len__(self):
        return self._count
    ...
    # Adds a new entry to the map if the key does not exits. Otherwise,
    ...
    # forInser indicates if the search is for an insertion, which locates
    ...
    def _rehash(self):
        ...
        # add the key form the original array to the new table.
    ...
    # The main hash function for mapping keys tok table entries.
    def _hash1(self, key):
        return abs(hash(key)) % len(self._table) 
    
    # The second hash functions used with double hashing probs.
    def _hash2(self, key):
